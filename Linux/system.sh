...
# Free memory output to a free_mem.txt file use -h for readable format
free -h > ~/backups/freemem/free_mem.txt

# Disk usage output to a disk_usage.txt file use -h for readable format
du -h > ~/backups/diskuse/disk_usage.txt

# List open files to a open_list.txt file
lsof > ~/backups/openlist/open_list.txt

# Free disk space to a free_disk.txt file use -h for readable format
